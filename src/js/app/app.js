(function () {
  ...
  // NOTE: looked at gulp-angular-modules (https://github.com/yagoferrer/gulp-angular-modules) which should make it possible to get rid of manually managing the list of dependencies. However, I couldn't get this to work.
  angular.module('app', [
    // libraries
    'ionic',
  ...
  .run(function ($ionicPlatform, $ionicPopup, $ionicSideMenuDelegate, $ionicHistory, $state, $rootScope, $translate, $log, $timeout, $cordovaDevice, loggingDecorator, Application, APP, UserService, FirebaseConfiguration) {
